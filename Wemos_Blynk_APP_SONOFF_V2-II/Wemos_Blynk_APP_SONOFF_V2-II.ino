...
char auth[] = "50c7e186fc1e4a4abcf4b433ab687e25";
...
void ICACHE_RAM_ATTR CheckPulsador ();
...
// Al arrancar sincroniza el estado del rele con el valor de la nube
  Blynk.syncVirtual(vManualAppRelay);
}
